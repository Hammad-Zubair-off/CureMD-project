...
// GET /api/doctors                    Search & filter approved doctors
router.get('/', searchValidator, searchDoctors);

// GET /api/doctors/specializations    Distinct specializations for search dropdown
router.get('/specializations', getSpecializations);

// =============================================================================
// DOCTOR — profile  (role: doctor)
// These static paths must be declared before /:id
// =============================================================================

// POST /api/doctors/profile           Register own profile (called once after signup)
router.post('/profile', protect, authorize('doctor'), createProfileValidator, createProfile);

// GET  /api/doctors/profile/me        View own full profile
...
// =============================================================================
// DOCTOR — availability  (role: doctor)
// =============================================================================

// GET  /api/doctors/availability/me   View own weekly schedule
router.get('/availability/me', protect, authorize('doctor'), getMyAvailability);

// PUT  /api/doctors/availability      Replace full weekly availability schedule
...
// GET  /api/doctors/admin/pending     Doctors awaiting approval
router.get('/admin/pending', protect, authorize('admin', 'superadmin'), getPendingDoctors);

// GET  /api/doctors/admin/all         All doctors with optional filters
...
// PATCH /api/doctors/admin/:id/rating  (called internally by appointment-service)
router.patch('/admin/:id/rating', protect, authorize('admin', 'superadmin'), mongoIdParam('id'), updateRating);

// =============================================================================
// DYNAMIC :id  — MUST be last — catches anything not matched above
// =============================================================================

// GET /api/doctors/:id/availability   Public slots for a doctor (appointment booking flow)
